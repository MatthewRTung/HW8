...
public class XMLTestClass {
  ...
  public void testReadXMLFile_EmptyFile() {
    ...
    List<Event> events = xmlConfigurator.readXMLFile("empty.xml");
  ...
  public void testWriteXMLFile_WriteReadConsistency() {
    XMLConfigurator xmlConfigurator = new XMLConfigurator();
    List<Event> eventsToWrite = new ArrayList<>();
    ...
    List<Event> eventsReadBack = xmlConfigurator.readXMLFile(filePath);
